...
public class ArrayListExplorerTester {
        public static void main(String[] args) {
                ...
                ArrayListsExplorer.removeZeros(nums);
                ...
                System.out.println("Expected: 18 \n Actual: " + ArrayListsExplorer.countLetters(words));

                System.out.println();

                System.out.println("Test keyPosition: find a 1");
                System.out.println(nums);
                System.out.println("Expected: 2 \n Actual: " + ArrayListsExplorer.findPosition(1, nums));

                System.out.println();

                System.out.println("Test parse into array");
                System.out.println("Expected: [W, e, s, t, , L, i, n, n] \n Actual: " + ArrayListsExplorer.parseIntoArrayList("West Linn"));
                ...
                System.out.println("Expected: BETTY \n Actual: " + ArrayListsExplorer.findMin(people));
